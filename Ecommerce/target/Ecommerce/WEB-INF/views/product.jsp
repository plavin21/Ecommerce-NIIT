...
<%@ include file = "header.jsp" %>
  ...
  <div itemscope itemtype="http://schema.org/Product">
    <meta itemprop="url" content="resources/img/${produc.img }">
    <meta itemprop="image" content="resources/img/${produc.img }">
    <div class="shadow">
      <div class="_cont detail-top">
        <div class="cols">
          <div class="left-col">
            <div class="thumbs">
              <a class="thumb-image active" href="//cdn.shopify.com/s/files/1/1047/6452/products/product_1024x1024.png?v=1446769025" data-index="0">
                <span><img src="resources/img/${produc.img }" alt="Tommy Hilfiger T-Shirt New York"></span>
              </a>
            ...
            <div class="big">
              <span id="big-image" class="img" quickbeam="image" style="background-image: url('resources/img/${produc.img }')" data-src="//cdn.shopify.com/s/files/1/1047/6452/products/product_1024x1024.png?v=1446769025"></span>
          ...
          <div class="right-col">
            <h1 itemprop="name" style="color:#fff;">${produc.name }</h1>
            <div itemprop="offers" itemscope itemtype="http://schema.org/Offer">
              ...
              <div class="swatches">
                <div class="swatch clearfix" data-option-index="0">
                  <div class="header" style="color:#fff;">Size</div>
                ...
                <div class="swatch clearfix" data-option-index="1">
                  <div class="header"style="color:#fff;">Color</div>
