...
<div class="container">
	<table id="update"  style="color:#fff" >
    				<thead>
						<tr>
							<th style="width:50%">CATEGORY LIST</th>
	...
	<div class="col-sm-2 "><img src="img/3.jpg" alt="Chania" width="100" height="100" class="img-responsive"/></div>
			...
			<h4 class="nomargin"> ${designatee.c_title}</h4>
			<p>        </p>
			
		</div>
     </div>
	</td>
	<td data-th="update"><a  href="catupd?id=${designatee.c_id}"><button class="button" 
	style="vertical-align:middle"><span>Edit </span></button></a></td>
	<td data-th="update1"><a href="catdel?id=${designatee.c_id}"><button class="button" 
